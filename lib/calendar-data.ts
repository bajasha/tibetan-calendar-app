...
export const march2026Events: CalendarEvent[] = [
  ...
  // Demo: busy days to preview "Ещё N" in calendar cells
  {
    id: 'demo-5-1',
    ...
    type: 'practice',
    description: 'Group morning meditation session.',
    descriptionRu: 'Групповая утренняя медитация.',
    color: 'bg-element-wood',
  },
  {
    id: 'demo-5-2',
    title: 'Tsok offering',
    titleRu: 'Подношение цог',
    startDate: new Date(2026, 2, 5),
    endDate: new Date(2026, 2, 5),
    type: 'practice',
    description: 'Tsok offering ceremony.',
    descriptionRu: 'Церемония подношения цог.',
    color: 'bg-element-fire',
  },
  {
    id: 'demo-5-3',
    title: 'Dharma teaching',
    titleRu: 'Учение по Дхарме',
    startDate: new Date(2026, 2, 5),
    endDate: new Date(2026, 2, 5),
    type: 'practice',
    description: 'Public dharma teaching.',
    descriptionRu: 'Публичное учение по Дхарме.',
    color: 'bg-element-earth',
  },
  {
    id: 'demo-5-4',
    title: 'Prostration practice',
    titleRu: 'Практика простираний',
    startDate: new Date(2026, 2, 5),
    endDate: new Date(2026, 2, 5),
    type: 'practice',
    description: 'Prostration practice session.',
    descriptionRu: 'Практика простираний.',
    color: 'bg-element-metal',
  },
  {
    id: 'demo-5-5',
    title: 'Candle lighting',
    titleRu: 'Зажжение свечей',
    startDate: new Date(2026, 2, 5),
    endDate: new Date(2026, 2, 5),
    type: 'practice',
    description: 'Evening candle lighting ritual.',
    descriptionRu: 'Вечерний ритуал зажжения свечей.',
    color: 'bg-element-water',
  },
  {
    id: 'demo-8-1',
    title: 'Green Tara puja',
    titleRu: 'Пуджа Зелёной Тары',
    startDate: new Date(2026, 2, 8),
    endDate: new Date(2026, 2, 8),
    type: 'practice',
    description: 'Green Tara puja ceremony.',
    descriptionRu: 'Пуджа Зелёной Тары.',
    color: 'bg-element-fire',
  },
  {
    id: 'demo-8-2',
    title: '21 Praises recitation',
    titleRu: '21 Восхваление Тары',
    startDate: new Date(2026, 2, 8),
    endDate: new Date(2026, 2, 8),
    type: 'practice',
    description: 'Recitation of the 21 Praises to Tara.',
    descriptionRu: 'Чтение 21 Восхваления Таре.',
    color: 'bg-auspicious',
  },
  {
    id: 'demo-8-3',
    title: 'Lamp offering',
    titleRu: 'Подношение лампад',
    startDate: new Date(2026, 2, 8),
    endDate: new Date(2026, 2, 8),
    type: 'practice',
    description: 'Butter lamp offering.',
    descriptionRu: 'Подношение масляных лампад.',
    color: 'bg-element-earth',
  },
  {
    id: 'demo-15-1',
    title: 'Miracle day prayers',
    titleRu: 'Молитвы Дня Чудес',
    startDate: new Date(2026, 2, 15),
    endDate: new Date(2026, 2, 15),
    type: 'practice',
    description: 'Special prayers on Chotrul Duchen.',
    descriptionRu: 'Особые молитвы в Чотрул Дюйчен.',
    color: 'bg-element-wood',
  },
  {
    id: 'demo-15-2',
    title: 'Merit accumulation',
    titleRu: 'Накопление заслуг',
    startDate: new Date(2026, 2, 15),
    endDate: new Date(2026, 2, 15),
    type: 'practice',
    description: 'Merit multiplication practices.',
    descriptionRu: 'Практики умножения заслуг.',
    color: 'bg-element-fire',
  },
  {
    id: 'demo-15-3',
    title: 'Community gathering',
    titleRu: 'Общинное собрание',
    startDate: new Date(2026, 2, 15),
    endDate: new Date(2026, 2, 15),
    type: 'holiday',
    description: 'Community celebration gathering.',
    descriptionRu: 'Общинное праздничное собрание.',
    color: 'bg-primary',
  },
]
